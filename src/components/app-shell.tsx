...
export function AppShell({ accounts, automaticPaymentsAvailable, children }: { accounts: Account[]; automaticPaymentsAvailable: boolean; children: ReactNode }) {
  ...
  const links = [
    { href: homePath, label: "Inicio", icon: "home" },
